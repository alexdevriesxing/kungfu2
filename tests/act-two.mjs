...
if(mode==='static'){
  ...
  const serviceWorker=fs.existsSync('sw-legacy.js')?'sw-legacy.js':fs.existsSync('sw-act4.js')?'sw-act4.js':fs.existsSync('sw-act3.js')?'sw-act3.js':'sw-act2.js';
  ...
  if(!sw.includes('act-two.js')||!sw.includes('act-two-compat.js')||!/(green-dragon-v5-act2-1|green-dragon-v6-act3|green-dragon-v7-act4|green-dragon-v8-legacy)/.test(sw))fail('Current offline cache does not preserve Act II.');
